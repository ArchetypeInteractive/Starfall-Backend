...
sequenceDiagram
    ...
    Player1->>Player1: Uses match public key for secure communication
    Player2->>Player2: Uses match public key for secure communication
    PlayerN->>PlayerN: Uses match public key for secure communication
